...
$this->title = 'Create Car Packages';
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?= Html::a('<i class="fa-th-list"></i><span> Manage Car Packages</span>', ['car-packages'], ['class' => 'btn btn-warning  btn-icon btn-icon-standalone']) ?>
                <div class="panel-body">
